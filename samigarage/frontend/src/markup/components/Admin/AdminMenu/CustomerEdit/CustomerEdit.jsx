...
useEffect(() => {
 ...
 const handleSave = async () => {
   try {
     ...
     // Log the URL and data before sending the request
     console.log("Sending data to:", `${api_url}/api/customers/${customer_id}`);
     ...
     // Since response is already a JSON object, we don't need response.json()
    ...
    <div className="row clearfix">
      ...
      {customer ? (
        <div className="contact-form">
          ...
          {/* Editable form fields with placeholders */}
          <div>
            <input
              type="text"
          ...
          <div>
            <select
              ...
              onChange={(e) =>
                setCustomer({
                  ...customer,
                  active_customer_status: e.target.value === "1" ? 1 : 0, // Convert to 0 or 1
                })
              }
            >
