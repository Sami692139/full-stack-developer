        ...
        <div className="internal-wrapper">
          ...
          <div className="footer-link-wrapper">
            ...
            <div className="link-wrapper-2">
              ...
              <h3 className="midel-h3">Account</h3>
              <ul>
                <li>
            ...
            <div className="link-wrapper-4">
              ...
              <h3 className="midel-h3">For Education</h3>
              <ul>
                <li>
              ...
              <h3 className="midel-h3">For Healthcare</h3>
              <ul>
                <li>
                  <a href="">Manage Your Apple ID</a>
                </li>
              ...
              <h3 className="midel-h3">For Government</h3>
              <ul>
                <li>
                  <a href="">Apple and Education</a>
                </li>
            ...
            <div className="link-wrapper-5">
              ...
              <h3 className="midel-h3">About Apple</h3>
              <ul>
                <li>
                  <a href="">Find a Store</a>
                </li>
